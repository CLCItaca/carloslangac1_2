...
class EditarUsuarioAdmin extends StatefulWidget {
  final User usuario;
  const EditarUsuarioAdmin({super.key, required this.usuario});

  @override
  State<EditarUsuarioAdmin> createState() => _EditarUsuarioAdminState();
}

class _EditarUsuarioAdminState extends State<EditarUsuarioAdmin> {
  bool _admin = false;
              ...
              children: [
                ...
                Checkbox(value: _admin, 
                  onChanged: (bool? value){
                    setState(() {
                      _admin = value!;
                      widget.usuario.changeAdmin();
                      print(widget.usuario.getAdmin());
                    });
                  }
                )
              ],
